' hotelli05.domainhotelli.fi Suojatun sähköpostin määritykset.vbs
'
...
' *************************************************************************
strIncServerAddress	   = "hotelli05.domainhotelli.fi"		 					' This is the address for the mail server
strOutServerAddress	   = "hotelli05.domainhotelli.fi"		 					' This is the address for the mail server
...
strAccount			   = "lauri@awara.fi"							' Mail account to connect as
strSecureConnection    = "00000001"					' Use a secure connection - 00000001 for true, 00000000 for false
strCloseText 		   = "Valitse Windows Live Mail, ennen kuin jatkat."
strFolderNotFoundText  = "Kohteen Windows Live Mail asennus ei onnistu. Seuraavaa hakemistoa ei löytynyt:"
strProgramNotFoundText = "Kohteen Windows Live Mail asennus ei onnistu. Seuraavaa tiedostoa ei löytynyt:"
strFileNotFoundText	   = "Tiedostoa ei löydy."
